		...
		<div class="fluid-container">
			<nav class="navbar navbar-default">
				...
				<div id="navbar" class="navbar-collapse collapse">
                   ...
                   <button onClick="parent.location='pplogin.php'"> <div class="primary log-in">Back</div></button> <!--<input type="Submit" name="HOME" value="HOME"> -->
					</ul>
				</div>
			</nav>
	  </div>
...
<form method="post" action="joincollege.php" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" placeholder="Enter Email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required><br>
