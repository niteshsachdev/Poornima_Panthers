...
<body>
    <form action="apanal.php" method="post">
 ...
 $ck=mysqli_query($conn,$query);
	 ...
	 while($rw=mysqli_fetch_array($ck))
       ...
       <tr>
         ...
         <?php
	        $dd=$_GET['dd'];
    $query=mysqli_query($conn,"UPDATE joincollege SET teamname='$teamname',tlname='$tlname',registrationid='$registrationid',mobileno='$mobileno',emailid='$emailid',year='$year',Events='Events' WHERE sn='$dd'");
         ...
         <td>
         <a href="apanal.php?dd=<?php echo $rw['sn']; ?>">edit</a>
         <a href="apanal.php?dd1=<?php echo $rw['sn']; ?>">delete</a>
         </td>
...
$query=mysqli_query($conn,"delete from joincollege where sn='$dd1'");
if($query)
{
